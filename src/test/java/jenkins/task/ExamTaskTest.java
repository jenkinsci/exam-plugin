...
public class ExamTaskTest {
    ...
    public void getUseExecutionFile() {
        ...
        assertEquals(true, testObject.getUseExecutionFile());
    }
    
    @Test
    public void setUseExecutionFile() {
        testObject.setUseExecutionFile(false);
    ...
    public void setSystemConfiguration() {
        ...
        String setModelConfig = Whitebox.getInternalState(testObject, "examSysConfig");
