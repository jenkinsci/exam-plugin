...
public class ExamTaskDescriptorTest {
    ...
    public void doFillPythonNameItems() {
        ...
        for (int i = 0; i < num; i++) {
            ...
            Util.createAndRegisterPythonInstallation(jenkinsRule, pythonName + "_" + i, "testHome");
        }
    ...
    public void doFillExamNameItems() {
        ...
        for (int i = 0; i < num; i++) {
            ...
            Util.createAndRegisterExamTool(jenkinsRule, examName + "_" + i, examHome, examRelativePath);
        }
    ...
    public void getInstallations() {
        ...
        for (int i = 0; i < num; i++) {
            expected[i] = Util.createAndRegisterExamTool(jenkinsRule, examName + "_" + i, examHome, examRelativePath);
        }
    ...
    public void getPythonInstallations() {
        ...
        for (int i = 0; i < num; i++) {
            expected[i] = Util
                    .createAndRegisterPythonInstallation(jenkinsRule, pythonName + "_" + i, "testHome");
        }
